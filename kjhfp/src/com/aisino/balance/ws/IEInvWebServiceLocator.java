...
public class IEInvWebServiceLocator extends org.apache.axis.client.Service implements com.aisino.balance.ws.IEInvWebService {
    ...
    private java.lang.String IEInvWebServiceHttpPort_address = "http://192.168.253.192:10000/zzs_balance/webservice/eInvWS//140114999999062";
    ...
    public com.aisino.balance.ws.IEInvWebServicePortType getIEInvWebServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.aisino.balance.ws.IEInvWebServicePortType getIEInvWebServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.aisino.balance.ws.IEInvWebServiceHttpBindingStub _stub = new com.aisino.balance.ws.IEInvWebServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.aisino.balance.ws.IEInvWebServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.aisino.balance.ws.IEInvWebServiceHttpBindingStub _stub = new com.aisino.balance.ws.IEInvWebServiceHttpBindingStub(new java.net.URL(IEInvWebServiceHttpPort_address), this);
                _stub.setPortName(getIEInvWebServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.balance.aisino.com", "IEInvWebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.balance.aisino.com", "IEInvWebServiceHttpPort"));
        }
