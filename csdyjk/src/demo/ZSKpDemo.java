...
public class ZSKpDemo {

	public static void main(String[] args) throws Exception {
		String xml = getXML();
		CoreserviceLocator service = new CoreserviceLocator();
		service.setcoreserviceHttpPortEndpointAddress("http://192.168.19.18:8080/fpgl_webservice/services/coreservice");
	...
	private static String getXML() throws UnsupportedEncodingException {
		String lsh = "70cskpyd45873405kd33";
		String content = 
			"<dzfp_info>\r\n" +
			"	<dzfp_fpt>\r\n" +
		...
		String xml = 
			...
			"		<authorizationCode>915951811C</authorizationCode >\r\n" +
	...
	private static String getPassword() {
		String zcm = "31106756";
		String sjs = "2389458984";
		String str = new String(new BASE64Encoder().encode(MD5Util.MD5(zcm + sjs).getBytes()));
		return sjs + str;
	}
}
