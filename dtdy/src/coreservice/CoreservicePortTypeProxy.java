...
public class CoreservicePortTypeProxy implements CoreservicePortType {
  private String _endpoint = null;
  private CoreservicePortType coreservicePortType = null;
  ...
  private void _initCoreservicePortTypeProxy() {
    try {
      coreservicePortType = (new CoreserviceLocator()).getcoreserviceHttpPort();
  ...
  public CoreservicePortType getCoreservicePortType() {
    if (coreservicePortType == null)
      _initCoreservicePortTypeProxy();
